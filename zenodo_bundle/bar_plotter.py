...
scenario = [ 'SSP119', 'SSP126', 'SSP245', 'SSP370', 'SSP585', 'CLE', 'MFR', 'CFM', 'MFR_SDS' ]
scenariox = [ 'SSP1-1.9', 'SSP1-2.6', 'SSP2-4.5', 'SSP3-7.0', 'SSP5-8.5', 'CLE', 'MFR', 'CFM', 'MFR_SDS' ]
cmip6 = [ True, True, True, True, True, False, False, False, False ]
...
#      print(str(iss[nfr])+' '+str(ise[nfr]))
      ...
      print('ERROR. ', splthgt_pos.shape, region_splits_pos.shape)
      print(splthgt_pos[nfr,:,ib])
