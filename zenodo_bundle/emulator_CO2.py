...
cs_co2_ar = [0.31, 0.17, 0.16, 0.06]              # 60N-90N (Arctic) 
cs_co2_ml = [0.06, 0.24, 0.17, 0.07]              # 28N-60N (mid latitudes)
cs_co2_tr = [0.02, 0.10, 0.24, 0.09]              # 28N-28S (tropics)
cs_co2_sh = [0.  , 0.02, 0.05, 0.19]              # 28S-90S (southern hemisphere)
