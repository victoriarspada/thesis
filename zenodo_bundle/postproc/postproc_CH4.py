# python3 postprocessor for emulator-simulated temperature changes due to CH4
...
modtemp = [ 'temp_ch4_CLE_zero_emulator_mean' ]  #  input file names (without file extension)
year_starty = 1995
year_endy = 2014
