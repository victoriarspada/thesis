# python3 postprocessor for emulator-simulated temperature changes due to CO2
...
modtemp = [ 'temp_co2_CLE_zero_emulator_mean' ]  #  input file names (without file extension)
year_starty = 1995
year_endy = 2014
