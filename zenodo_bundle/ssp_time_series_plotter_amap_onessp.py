...
for s in range(0, n_ssps, 1): # For each file (current SSP) 
    ...
    # anomaly averages
    # gm_tas_time_series_ensemble = np.array([gm_tas_time_series_ensemble[0,:], 
    #               gm_tas_time_series_ensemble[21,:],
    #               gm_tas_time_series_ensemble[42,:]])
    # arc_tas_time_series_ensemble = np.array([arc_tas_time_series_ensemble[0,:], 
    #               arc_tas_time_series_ensemble[21,:],
    #               arc_tas_time_series_ensemble[42,:]])
    # nhml_tas_time_series_ensemble = np.array([nhml_tas_time_series_ensemble[0,:], 
    #               nhml_tas_time_series_ensemble[21,:],
    #               nhml_tas_time_series_ensemble[42,:]])
    # tropics_tas_time_series_ensemble = np.array([tropics_tas_time_series_ensemble[0,:], 
    #               tropics_tas_time_series_ensemble[21,:],
    #               tropics_tas_time_series_ensemble[42,:]])
    # sh_tas_time_series_ensemble = np.array([sh_tas_time_series_ensemble[0,:], 
    #               sh_tas_time_series_ensemble[21,:],
    #               sh_tas_time_series_ensemble[42,:]])
